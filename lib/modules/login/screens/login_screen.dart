...
floatingActionButton: FloatingActionButton.extended(
  onPressed: () async {
    try {
      // Sign in using Firebase Authentication with Google Provider
      final userCredential = await FirebaseHelper.firebaseAuth.signInWithProvider(GoogleAuthProvider());
      
      if (userCredential.user != null) {
        // Log success message
        LoggerUtil().errorData("Success Sign Up :- ${userCredential.user}");
        ...
        // Show success toast
        ToastedNotification.successToast(context, description: "Login Successful");
